...
red_component=round(linspace(first_color(1),second_color(1),512));
green_component=round(linspace(first_color(2),second_color(2),512));
blue_component=round(linspace(first_color(3),second_color(3),512));
